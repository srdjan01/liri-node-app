...
function retrieveTweets() {
    ...
    var params = { screen_name: twitterSN, count: 20 };
...
function retrieveOBDBInfo(movie) {
    ...
    var queryStr = 'http://www.omdbapi.com/?t=' + search + '&plot=full&tomatoes=true&apikey=' + omdbApiKey;
